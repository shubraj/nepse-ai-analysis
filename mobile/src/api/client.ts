...
const API_BASE =
  (Constants.expoConfig?.extra as { apiUrl?: string } | undefined)?.apiUrl ?? "http://localhost:8212/api";
...
import type { Company, CompanyAnalysisListItem, CompanyAnalysisResponse } from "../types/company";
